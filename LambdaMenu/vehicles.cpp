...
constexpr const char* VALUES_SUPERCARS[] = { "VAGNER", "XA21", "GP1", "ITALIGTB", "ITALIGTB2", "NERO", "NERO2", "TEMPESTA", "PENETRATOR", "VOLTIC2", "LE7B", "BANSHEE2", "VOLTIC", "SHEAVA", "CHEETAH", "PROTOTIPO", "TURISMOR", "SULTANRS", "ENTITYXF", "INFERNUS", "OSIRIS", "REAPER", "VACCA", "ZENTORNO", "PFISTER811", "T20", "TYRUS", "ADDER", "BULLET", "FMJ" };

constexpr const char* VALUES_SPORTS[] = { "RUSTON", "SPECTER", "SPECTER2", "COMET3", "ALPHA", "ELEGY2", "ELEGY", "FELTZER2", "SCHWARZER", "SURANO", "RAPTOR",  "BANSHEE", "BUFFALO", "BUFFALO2", "BUFFALO3", "VERLIERER2", "TAMPA2", "MASSACRO", "MASSACRO2", "RAPIDGT", "RAPIDGT2", "SEVEN70", "BLISTA2", "BLISTA3", "JESTER", "JESTER2", "BESTIAGTS", "CARBONIZZARE", "KHAMELION", "COQUETTE", "FUTO", "KURUMA", "KURUMA2", "SULTAN", "FUROREGT", "TROPOS", "PENUMBRA", "NINEF", "NINEF2", "OMNIS", "LYNX", "COMET2", "FUSILADE" };

constexpr const char* VALUES_SPORTCLASSICS[] = { "TORERO", "ARDENT", "CHEETAH2", "INFERNUS2", "TURISMO2", "MANANA", "BTYPE", "BTYPE3", "FELTZER3", "TORNADO", "TORNADO3", "TORNADO2", "TORNADO4", "TORNADO6", "JB700", "STINGER", "STINGERGT", "COQUETTE2", "CASCO", "PIGALLE", "MONROE", "ZTYPE", "PEYOTE" };

constexpr const char* VALUES_MUSCLE[] = { "TAMPA3", "RUINER2", "BUCCANEER", "BTYPE2", "LURCHER", "VIRGO", "GAUNTLET", "GAUNTLET2", "PICADOR", "MAMBA", "TAMPA", "SABREGT", "STALION", "STALION2", "VIGERO", "VOODOO2", "VIRGO3", "DUKES2", "DUKES", "NIGHTSHADE", "PHOENIX", "RUINER", "COQUETTE3", "BLADE", "CHINO", "DOMINATOR", "DOMINATOR2", "HOTKNIFE", "SLAMVAN", "SLAMVAN2", "FACTION" };
...
constexpr const char* VALUES_OFFROAD[] = { "TECHNICAL3", "NIGHTSHARK", "INSURGENT3", "DUNE3", "BLAZER5", "TECHNICAL2", "DUNE4", "DUNE5", "DUBSTA3", "BIFTA", "BFINJECTION", "DUNE", "DLOADER", "DUNE2", "BODHI2", "KALAHARI", "MESA3", "MARSHALL", "BRAWLER", "RANCHERXL", "RANCHERXL2", "INSURGENT2", "INSURGENT", "REBEL2", "REBEL", "TECHNICAL", "BLAZER", "BLAZER3", "BLAZER2", "BLAZER4", "TROPHYTRUCK2", "GUARDIAN", "MONSTER", "SANDKING2", "SANDKING", "TROPHYTRUCK" };
...
constexpr const char* CAPTIONS_VANS[] = { "Armoured Boxville", "BF Surfer", "BF Surfer (Rusty)", "Bravado Paradise", "Bravado Rumpo Custom", "Bravado Rumpo (Deludamol)", "Bravado Rumpo (Weazel News)", "Bravado Youga", "Bravado Youga Classic", "Brute Camper", "Brute Pony (Business)", "Brute Pony (Cannibus Shop)", "Brute Taco Van", "Declasse Burrito", "Declasse Burrito (Bug Stars)", "Declasse Burrito (Construction)", "Declasse Burrito (Gang)", "Declasse Burrito (Graphics)", "Declasse Burrito (Snow)", "Declasse Burrito (The Lost)", "Declasse Moonbeam", "Vapid Minivan", "Vapid Speedo", "Vapid Speedo (Clown)", "Zirconium Journey" };

constexpr const char* CAPTIONS_TRUCKS[] = { "JoBuilt Phantom Custom", "JoBuilt Hauler Custom", "Phantom Wedge", "Brute Boxville (Go Postal)", "Brute Boxville (Humane Labs)", "Brute Boxville (Post OP)", "Brute Boxville (Water & Power)", "Brute Stockade", "Brute Stockade (Snow)", "Brute Tipper (2 Axle)", "Brute Tipper (3 Axle)", "Cutter", "Dock Handler", "Dock Tug", "Dump Truck", "HVY Biff", "Jobuilt Hauler", "Jobuilt Phantom", "Jobuilt Rubble", "Maibatsu Mule (Graphics 1)", "Maibatsu Mule (Graphics 2)", "Maibatsu Mule (Plain)", "Mixer", "Mixer (Support Wheel)", "MTL Flatbed Truck", "MTL Packer", "MTL Pounder", "Vapid Benson", "Vapid Scrap Truck", "Vapid Tow Truck", "Vapid Tow Truck (Old)" };
...
constexpr const char* CAPTIONS_TRAILERS[] = { "AA Turret Trailer", "Army Flatbed Trailer (Empty)", "Army Flatbed Trailer (With Drill)", "Army Fuel Tanker", "Boat Trailer", "Boat Trailer", "Car Transport Trailer", "Car Transport Trailer (Empty)", "Commercial Trailer (Graphics 1)", "Commercial Trailer (Graphics 2)", "Container Trailer", "Fame or Shame Trailer", "Flatbed Trailer", "Flatbed Trailer", "Grain Trailer", "Hay Bale Trailer", "Logging Trailer", "Meth Lab Trailer", "Petrol Tanker Trailer (Plain)", "Petrol Tanker Trailer (RON)", "Plain Trailer", "Rake Trailer", "Small Trailer" };
...
constexpr const char* VALUES_VANS[] = { "BOXVILLE5", "SURFER", "SURFER2", "PARADISE", "RUMPO3", "RUMPO2", "RUMPO", "YOUGA", "YOUGA2", "CAMPER", "PONY", "PONY2", "TACO", "BURRITO3", "BURRITO2", "BURRITO4", "GBURRITO2", "BURRITO", "BURRITO5", "GBURRITO", "MOONBEAM", "MINIVAN", "SPEEDO", "SPEEDO2", "JOURNEY" };

constexpr const char* VALUES_TRUCKS[] = { "PHANTOM3", "HAULER2", "PHANTOM2", "BOXVILLE2", "BOXVILLE3", "BOXVILLE4", "BOXVILLE", "STOCKADE", "STOCKADE3", "TIPTRUCK", "TIPTRUCK2", "CUTTER", "HANDLER", "DOCKTUG", "DUMP", "BIFF", "HAULER", "PHANTOM", "RUBBLE", "MULE", "MULE2", "MULE3", "MIXER", "MIXER2", "FLATBED", "PACKER", "POUNDER", "BENSON", "SCRAP", "TOWTRUCK", "TOWTRUCK2" };
...
constexpr const char* VALUES_TRAILERS[] = { "TRAILERSMALL2", "ARMYTRAILER", "ARMYTRAILER2", "ARMYTANKER", "BOATTRAILER", "TR3", "TR4", "TR2", "TRAILERS2", "TRAILERS3", "DOCKTRAILER", "TVTRAILER", "FREIGHTTRAILER", "TRFLAT", "GRAINTRAILER", "BALETRAILER", "TRAILERLOGS", "PROPTRAILER", "TANKER2", "TANKER", "TRAILERS", "RAKETRAILER", "TRAILERSMALL" };
...
constexpr const char* VALUES_EMERGENCY[] = { "APC", "HALFTRACK", "POLICEOLD2", "AMBULANCE", "BARRACKS", "BARRACKS2", "FBI", "RIOT", "CRUSADER", "FBI2", "LGUARD", "PRANGER", "POLICEOLD1", "POLICET", "SHERIFF2", "FIRETRUK", "PBUS", "RHINO", "POLICE2", "POLICE", "POLICE3", "SHERIFF", "POLICE4", "POLICEB" };
